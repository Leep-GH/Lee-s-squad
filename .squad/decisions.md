...
### 2026-04-02: detect-squad-dir.ts zero-dependency boundary

**Author:** EECOM
**PR:** #756

detect-squad-dir.ts must remain zero-dependency (only node:fs and node:path). Regression guard test added. Bootstrap utilities cannot depend on SDK.

### 2026-04-02: PR #756 Quality Review - APPROVED

**Reviewer:** FIDO
**Verdict:** ✅ APPROVE

Fix is thorough, regression guard solid, all tests pass.

### 2026-04-02: PR #756 Architecture Review - APPROVED

**Reviewer:** Flight
**Verdict:** ✅ APPROVE (scope expansion recommended)

Identified 4 additional bootstrap utilities needing zero-dependency protection: errors.ts, gh-cli.ts, output.ts, history-split.ts.

### 2026-04-02: Protected Files guardrail in copilot-instructions.md

**Author:** Procedures

Added 'Protected Files — Zero External Dependencies' section to .github/copilot-instructions.md. Bootstrap utilities that run before SDK loads must only use Node.js built-ins.
